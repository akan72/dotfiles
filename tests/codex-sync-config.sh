...
assert_value '.desktop."git-branch-prefix"' 'akan72/'
assert_value '.desktop."git-pull-request-merge-method"' 'squash'
assert_value '.desktop."git-commit-instructions"' 'Commit messages should be concise, just one sentence'
assert_value '.desktop."git-pr-instructions" | contains("## Summary")' 'true'
assert_value '.desktop."ambient-suggestions-enabled"' 'false'
