...
# See `man tmux` for additional formatting options for the status line. # The `format regular` and `format inverse` functions are provided as conveniences
...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		...
		#"wan_ip 24 255"
		# segment args: "<name> <bg> <fg>" — bg/fg are 256-color palette codes (237 = dark grey, 214 = amber)
		"vcs_branch 237 214"
		"now_playing 234 37"
		#"vcs_compare 60 255"
		#"vcs_staged 64 255"
